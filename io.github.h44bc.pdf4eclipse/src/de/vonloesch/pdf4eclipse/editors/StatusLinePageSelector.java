...
public class StatusLinePageSelector extends ContributionItem {
	...
	public void fill(Composite parent) {
		...
		int averageCharWidth = Math.max(1, gc.textExtent("0123456789").x / 10);
		int widthHint = averageCharWidth * charWidth;
		int heightHint = fm.getHeight();
		
		GridData d = new GridData(averageCharWidth * 4 + pageField.getBorderWidth(), 
